...
<head>
    ...
    <title>Stiven Tecno Store</title>
...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.php">Stiven Tecno Store</a>
        <!-- Sidebar Toggle-->
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Stiven Tecno Store</h1>
                                ...
                                <table class="table table-bordered" id="datatablesSimple" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        while ($data = mysqli_fetch_array($ambilsemuadatastock)) {
                                            ...
                                            <!-- Modal detail barang -->
                                            <div class="modal fade" id="detail<?= $idb; ?>">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mb-3 row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        ...
                                                                        <!-- akhir -->
                                                                        <input type="text" class="form-control" class="form-control" value="<?= $namabarang?>" readonly>
                                                                    </div>
                                                                </div>
                                                                <div class="mb-3 row">
                                                                    <label class="col-sm-4 col-form-label">Stok</label>
                                                                    <div class="col-sm-8">
                                                                        <input type="number" name="stok" class="form-control" value="<?= $stock ?>" readonly>
                                                                    </div>
                                                                </div>
                                                                <div class="mb-3 row">
                                                                    <label class="col-sm-4 col-form-label">Deskripsi</label>
                                                                    <div class="col-sm-8">
                                                                        <textarea class="form-control" readonly><?= $deskripsi?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
